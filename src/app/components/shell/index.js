  ...
  render() {
    return (
      <div style={flex}>
        ...
        <LeftNav isOpen={this.props.leftNav.isOpen} user={this.props.user} toggle={this.props.toggle}
                 logout={this.props.logout} redirect={this.props.redirect} hasRole={hasRole}/>
        <div style={content}>
          {this.props.children}
        </div>
      </div>
